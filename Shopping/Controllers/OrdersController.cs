...
namespace Shopping.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Dispatch(int? id)
        {
            ...
            {
                sale.OrderStatus = OrderStatus.Despachando;
                _context.Sales.Update(sale);
                await _context.SaveChangesAsync();
                _flashMessage.Confirmation("El estado del pedido ha sido cambiado a 'despachando'.");
            }
        ...
        public async Task<IActionResult> Send(int? id)
        {
            ...
            if (sale.OrderStatus != OrderStatus.Despachando)
            {
                _flashMessage.Danger("Solo se pueden enviar pedidos que estén en estado 'despachando'.");
            }
            else
            {
