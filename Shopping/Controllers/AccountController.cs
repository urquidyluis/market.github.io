    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                Response response = _mailHelper.SendMail(
                    ...
                    $"<h1>Shopping - Confirmación de Email</h1>" +
                        ...
                        $"<hr/><br/><p><a \"btn btn-primary\" href = \"{tokenLink}\"><b>Confirmar Email</b></a></p>");
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    _flashMessage.Danger("La nueva contraseña no debe ser igual a la anterior");
                    //ModelState.AddModelError(string.Empty, "La nueva contraseña no debe ser igual a la anterior");
                    return View(model);
                }
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                _mailHelper.SendMail(
                    ...
                    $"<p><a class = \"btn btn-primary\"  href = \"{link}\"><b>Reset Password</b></a></p>");
